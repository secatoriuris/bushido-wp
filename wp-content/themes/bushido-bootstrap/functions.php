...
// add_action( 'wp_enqueue_scripts', 'hapkido_enqueue_styles' );
...
add_action( 'wp_enqueue_scripts', 'navbar_scroll_style' ); 
function navbar_scroll_style() {
...
function blockmod_enqueue() {
    wp_enqueue_script( 'blockmod', get_stylesheet_directory_uri() . '/js/blockmod.js', array() );
}
